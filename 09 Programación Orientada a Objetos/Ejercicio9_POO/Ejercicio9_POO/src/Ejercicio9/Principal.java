...
/* 
    Ejercicio 9. Hacer un programa para calcular el área de Polígonos (Triángulos y Rectángulos) el programa debe de ser capaz de 
    almacernar en un arreglo de N triángulos y rectángulos, y al final, mostrar el área y los datos de cada uno. Para ello se 
    tendrá lo siguiente:
